...
function Links() {
    return (
        <div id="links">
                ...
                <div className="links">
                    <ul>
                        <li><a href="https://benferch.de/twitter" target="_blank" rel="noreferrer noopener"><svg
                                    aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter"
                                    className="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <li><a href="https://benferch.de/github" target="_blank" rel="noreferrer noopener"><svg
                                    aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github"
                                    className="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                                    <path fill="currentColor"
                        ...
                        <li><a href="https://benferch.de/gitlab" target="_blank" rel="noreferrer noopener"><svg
                                    aria-hidden="true" focusable="false" data-prefix="fab" data-icon="gitlab"
                                    className="icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                                    <path fill="currentColor"
                        ...
                        <li><a href="https://benferch.de/linkedin" target="_blank" rel="noreferrer noopener"><svg
