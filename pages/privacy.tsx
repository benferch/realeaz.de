...
export default function PrivacyPage() {
	...
	return (
		<>
			<CustomHead title="Privacy Policy | Ben-J. Ferch" desc="Hey!" />
			<Container className="my-12">
				...
				<Heading level={3}>Verantwortlicher</Heading>
				<Text>
					<span className="tsmcontroller">
						...
						<br />
						https://benferch.de/imprint
					</span>
				</Text>
				<Heading level={3}>Arten der verarbeiteten Daten</Heading>
				<Text>
				...
				<Heading level={3}>Kategorien betroffener Personen</Heading>
				<Text>
				...
				<Heading level={3}>Zweck der Verarbeitung</Heading>
				<Text>
				...
				<Heading level={3}>Verwendete Begrifflichkeiten </Heading>
				<Text>
				...
				<Heading level={3}>Maßgebliche Rechtsgrundlagen</Heading>
				<Text>
				...
				<Heading level={3}>Sicherheitsmaßnahmen</Heading>
				<Text>
				...
				<Heading level={3}>Übermittlungen in Drittländer</Heading>
				<Text>
				...
				<Heading level={3}>Rechte der betroffenen Personen</Heading>
				<Text>
				...
				<Text>
					...
					Seite{' '}
					<CustomLink none external target="http://www.aboutads.info/choices/">
						http://www.aboutads.info/choices/
					</CustomLink>{' '}
					oder die EU-Seite{' '}
					<CustomLink none external target="http://www.youronlinechoices.com/">
				...
				<Heading level={3}>Löschung von Daten</Heading>
				<Text>
				...
				<Heading level={3}>Hosting und E-Mail-Versand</Heading>
				<Text>
					<span className="ts-muster-content">
				...
				<Heading level={3}>Erhebung von Zugriffsdaten und Logfiles</Heading>
				<Text>
					<span className="ts-muster-content">
				...
				<CustomLink none external target="https://datenschutz-generator.de">
